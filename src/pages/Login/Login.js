      ...
      <div className={style.container}>
        <div className={style.loginBox}>
          ...
          <div className={style.findBox}>
            ...
            <Link className={style.findId} to="/find/findId">아이디 찾기</Link>
            <Link className={style.findPw} to="/find/findPw">비밀번호 찾기</Link>
          </div>
        </div>
        <div className={style.estateLoginBox}>
          ...
          <div className={style.findBox}>
            ...
            <Link className={style.findId} to="/find/findenrollmentId">아이디 찾기</Link>
